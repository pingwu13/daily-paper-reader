...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-05 22:23:06 UTC<br>状态：成功</p>
</section>
...
<p>今日速读 1 篇论文，聚焦低比特量化方案；其中《OCGQuant》提出 outlier-companion grouping 以优化 NVFP4 量化效果；建议关注该方法的异常值处理思路，适合入门了解前沿量化压缩。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="OCGQuant: Outlier-Companion Grouping for NVFP4 Quantization">OCGQuant: Outlier-Companion Grouping for NVFP4 Quantization</span></li></ul>
  </div>
