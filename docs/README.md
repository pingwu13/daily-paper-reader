...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-17 22:30:14 UTC<br>状态：成功</p>
</section>
...
<p>今日精读 1 篇：《Breaking the 1.58-bit Barrier for Ternary LLMs》以 9.0 分聚焦三值大模型突破 1.58-bit 极限。最值得关注的是它如何进一步压缩三值 LLM 的精度瓶颈，为超低比特推理提供新思路。普通读者可先看其方法核心与实验对比，再判断是否值得跟进复现。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Breaking the 1.58-bit Barrier for Ternary LLMs">Breaking the 1.58-bit Barrier for Ternary LLMs</span></li></ul>
  </div>
