...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-13 21:08:19 UTC<br>状态：成功</p>
</section>
...
<p>今日日报只收1篇速读、精读0篇，唯一入账是《Shift-Accumulate Attention》拿下6.0分。</p>
<p>最值得看的是它围绕Transformer解码，探索用移位累加实现无乘法的Query-Key乘积，属于注意力计算加速方向。</p>
<p>普通读者可先读摘要和实验结论，确认它是否真能省算力又不伤精度，再决定要不要精读</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Shift-Accumulate Attention: Multiplier-Free Query--Key Products for Transformer Decoding">Shift-Accumulate Attention: Multiplier-Free Query--Key Products for Transformer Decoding</span></li></ul>
  </div>
